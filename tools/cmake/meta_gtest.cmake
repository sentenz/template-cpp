...
function(meta_gtest)
  meta_parse_arguments(
    OPTIONS WITH_GMOCK WITH_MAIN WITH_CTEST WITH_DDT
  ...
  if(ARG_WITH_CTEST AND NOT BUILD_TESTING)
    message(WARNING "${CMAKE_CURRENT_FUNCTION}(): 'BUILD_TESTING' must be enabled at the top level (e.g., include(CTest) in root CMakeLists.txt).")
  endif()
